				...
				<table class='table table-striped table-bordered'>
					...
					<tbody>
						<tr>
							<td>Matricula:</td>
							<td>
								<input class="spam3" placeholder="Matricula" type="text" value="<?php echo $usuario['matricula']; ?>">
							</td>
						</tr>
						<tr>
							<td>Nombre:</td>
							<td>
								<input class="spam3" placeholder="Apellido Paterno" type="text" value="<?php echo $usuario['nombre']; ?>">
							</td>
						...
						<tr>
							...
							<td>
								<input class="spam3" placeholder="Apellido Paterno" type="text" value="<?php echo $usuario['apellidopat']; ?>">
							</td>
						...
						<tr>
							...
							<td>
								<input class="spam3" placeholder="Apellido Materno" type="text" value="<?php echo $usuario['apellidomat']; ?>">
							</td>
						</tr>
						<tr>
							<td>Sexo:</td>
